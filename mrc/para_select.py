...
def dup_remove(doc):
    ...
    for p_idx in del_ids:
        if para_id!=None and p_idx < para_id:  
            prev_del_num += 1
...
if __name__ == "__main__":
    ...
    mode = "test"
    # data = "data/preprocessed/my_test/test_30.json"
    data = "data/preprocessed/testset/search.test.json"
    data2 = "data/preprocessed/testset/pre_search.test.json"
    with open(data,'r',encoding='utf-8',newline='\n') as g:
        with open(data2,'w',encoding='utf-8',newline='\n') as c:
        # line = line.strip()
        # if line == "":
        #     continue
            for line in tqdm(g.readlines()):
                ...
                c.write(json.dumps(sample, ensure_ascii=False))
